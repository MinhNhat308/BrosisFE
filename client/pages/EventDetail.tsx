...
import EventService, { type EventAPI } from "@/services/eventServiceProduction";
import { 
  Calendar, 
  Clock, 
  MapPin, 
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const registrationData = {
        ...
        student_id: formData.studentId, // MSSV
        student_avatar: formData.checkinImage || undefined, // Ảnh upload
